...
import 'package:karbarab/utils/device_utils.dart';
        ...
        return SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              _buildTile('Manufacturer:', '${device.model}'),
              _buildTile('Model:', '${device.model}'),
              _buildTile('IOS name:', '${device.name}'),
              _buildTile('IOS system name:', '${device.systemName}'),
              _buildTile('IOS system version:', '${device.systemVersion}')
            ],
          ),
        );
      },
